...
def run_lifecycle_smoke(work_dir: Path, *, require_installed: bool = False) -> dict[str, Any]:
    ...
    for resource_name in (
        ...
        "contracts/retry-lineage-contracts.v1.schema.json",
        "contracts/temporal-lifecycle-contracts.v3.schema.json",
        "contracts/retry-lineage-qualification.v1.schema.json",
        ...
        "fixtures/lifecycle/retry-lineage-mixed-custody.v0.8.json",
