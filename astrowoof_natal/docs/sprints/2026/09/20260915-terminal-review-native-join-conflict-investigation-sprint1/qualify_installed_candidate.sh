...
cp /repo/astrowoof_natal/tests/test_terminal_review_capture_binding_join.py /tmp/installed-tests/

cd /tmp
python -c "import importlib.metadata as m, astrowoof_natal_authoring as a; print('version', m.version('astrowoof-natal-authoring')); print('module', a.__file__); assert m.version('astrowoof-natal-authoring') == '0.4.64'; assert 'site-packages' in a.__file__"
