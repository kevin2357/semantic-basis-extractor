# Story 049: placement_b2c332f5559c165f
...
- Visible Pack Function operates in adventure dog mode through unspecified pattern.
...
- **Astrological source references:** canonical:object:natal:kevin:MC
- **Projection used by:** direct to dog, general, handler, hybrid
  ...
  - operators: ["aspire", "be_known_for", "direct", "direct_function", "perform_pack_role", "publicize"]
  - canonical object name: MC
  - source names: ["MC"]
  - canine domains: ["guardian_role", "greeter_role", "helper_role", "couch_supervision"]
  - source sign: Sagittarius
  - projected mode: adventure_dog_mode
  - house mapping policy: doghouse
  - projection composition: {"domain": null, "mode": "adventure_dog_mode", "operator": "visible_pack_function"}
