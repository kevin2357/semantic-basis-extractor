# Story 001: placement_2cd8d9c528a3b907
...
- Primary Companion Interface operates in nap spot loyalty mode through unspecified pattern.
...
- **Astrological source references:** canonical:object:natal:ella:DSC
- **Projection used by:** direct to dog, general, handler, hybrid
  ...
  - projection composition: {"domain": null, "mode": "nap_spot_loyalty_mode", "operator": "primary_companion_interface"}
...
- **Story 002:** Explore how the two functions named below interact in this dog. Show the recognizable behavioral tension, cooperation, or adjustment created by the conjunction.
